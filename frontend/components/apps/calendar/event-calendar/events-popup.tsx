...
import { EventItem, type CalendarEvent } from "@/components/apps/calendar/event-calendar";
...
export function EventsPopup({ date, events, position, onClose, onEventSelect }: EventsPopupProps) {
  ...
  return (
    <div
      ref={popupRef}
      className="bg-background absolute z-[900] max-h-96 w-80 overflow-auto rounded-md border shadow-lg"
      style={{
