...
import { handleGmailList, handleGmailSearch, handleGmailRead } from "./dist/handlers/gmail.js";
import fs from "fs";
...
async function testGmailIntegration() {
  ...
  try {
    ...
    if (listResult.messages && listResult.messages.length > 0) {
      ...
      const searchResult = await handleGmailSearch(
        { query: "is:important", limit: 3 },
        mockContext
      );
